  ...
  return (
    <div className="page-container" style={{ backgroundColor: '#fff', height: '100dvh', zIndex: 2000 }}>
       <div style={{ padding: '16px', paddingTop: 'calc(env(safe-area-inset-top, 0px) + 16px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f0f0f0' }}>
        ...
        <h2 style={{ fontSize: `calc(17px * var(--fs, 1))`, fontWeight: '800' }}>{isPrivate ? '프라이빗 크루 만들기' : '공개 크루 만들기'}</h2>
        <div style={{ width: '24px' }}></div>
      </div>

      <div style={{ padding: '24px 20px', paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 24px)' }}>
        <div style={{ marginBottom: '32px' }}>
          <label style={{ display: 'block', fontSize: `calc(13px * var(--fs, 1))`, fontWeight: '800', color: '#8e8e93', marginBottom: '8px' }}>크루 명칭</label>
          <input 
            type="text"
        ...
        <div style={{ marginBottom: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <label style={{ fontSize: `calc(13px * var(--fs, 1))`, fontWeight: '800', color: '#8e8e93' }}>입장 유형</label>
          ...
          <div style={{ backgroundColor: '#f8f9fa', padding: '16px', borderRadius: '16px', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: `calc(14px * var(--fs, 1))`, fontWeight: '700', marginBottom: '4px' }}>보안 입장 모드</div>
              <div style={{ fontSize: `calc(12px * var(--fs, 1))`, color: '#8e8e93', lineHeight: '1.5', marginBottom: isPrivate ? '12px' : 0 }}>초대 링크가 있거나 비밀번호를 아는 사용자만 참여할 수 있는 폐쇄형 모임입니다.</div>
              {isPrivate && (
                <input 
                  type="password"
                  ...
                  maxLength={4}
                  style={{ 
                    width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #eee', outline: 'none', fontSize: `calc(14px * var(--fs, 1))`, fontWeight: '800', letterSpacing: '4px', textAlign: 'center'
                  }}
                  value={password}
        ...
        <div style={{ marginBottom: '40px' }}>
           <label style={{ display: 'block', fontSize: `calc(13px * var(--fs, 1))`, fontWeight: '800', color: '#8e8e93', marginBottom: '16px' }}>최대 인원 설정 (3 ~ 1000명)</label>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ fontSize: `calc(16px * var(--fs, 1))`, fontWeight: '800', color: '#0056D2', width: '45px', textAlign: 'right' }}>{limit}</div>
              <div style={{ fontSize: `calc(14px * var(--fs, 1))`, fontWeight: '700', color: '#8e8e93' }}>명</div>
           </div>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '6px', marginTop: '20px', color: '#bbb' }}>
          <HelpCircle size={14} />
          <span style={{ fontSize: `calc(12px * var(--fs, 1))` }}>크루 운영 정책 자세히 보기</span>
        </div>
      </div>
