...
const SEASONAL_FISH = {
  '동해': {
    ...
    4:  ['도다리', '학꽁치', '감성돔', '벵에돔'],
    5:  ['감성돔', '학꽁치', '벵에돔', '무늬오징어'],
    // ☀️ 여름 — 삼치 금어기(6~7월). 오징어·볼락·농어·가자미 주력
    6:  ['가자미', '볼락', '농어', '우럭'],      // 실조황⭐⭐⭐ / 삼치 금어기
    7:  ['오징어', '전갱이', '볼락', '농어'],  // 오징어 시즌 분격화 / 삼치 금어기
    8:  ['오징어', '전갱이', '삼치', '방어'],  // 8/1~ 삼치 해금
    // 봄 — 방어·무늬오징어·감성돔 피크
    9:  ['방어', '전갱이', '무늬오징어', '삼치'],
    10: ['방어', '무늬오징어', '감성돔', '삼치'],
    // 회가울~겨울
  ...
  '남해': {
    ...
    4:  ['감성돔', '참돔', '벵에돔', '볼락'],
    5:  ['참돔', '감성돔', '벵에돔', '전갱이'],
    // ☀️ 여름 — 삼치·갈치 금어기. 한치·참돔·벵에돔 실조황⭐⭐⭐
    6:  ['참돔', '한치', '감성돔', '벵에돔'],  // 실조황: 참돔⭐⭐⭐ 한치⭐⭐⭐ / 삼치 금어기
    7:  ['한치', '전갱이', '참돔', '벵에돔'],  // 한치 최성기 / 갈치·삼치 금어기
    8:  ['갈치', '부시리', '삼치', '전갱이'],  // 8/1~ 갈치·삼치 해금
    // 가을 — 갈치·방어 피크
    9:  ['갈치', '방어', '부시리', '삼치'],
    10: ['방어', '감성돔', '갈치', '삼치'],
    // 회가울~겨울
