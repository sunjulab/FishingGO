...
const SEASONAL_FISH = {
  '동해': {
    // ❄️ 겨울 — 가자미·이면수·볼락·우럭 주력 | 볼락 11~5월 방파제 핵심
    1:  ['가자미', '이면수', '볼락', '우럭'],
    2:  ['가자미', '도다리', '볼락', '우럭'],
    // 봄 — 도다리·학꽁치 시즌 개막 | 노래미 3월부터 활성, 감성돔 활성
    3:  ['도다리', '학꽁치', '감성돔', '노래미'],
    4:  ['도다리', '학꽁치', '감성돔', '벵에돔'],
    5:  ['감성돔', '학꽁치', '벵에돔', '무늬오징어'],
    // ☀️ 여름 — 삼치 금어기(6~7월). 오징어·볼락·농어 주력
    6:  ['가자미', '볼락', '농어', '우럭'],      // 삼치 금어기
    7:  ['오징어', '전갱이', '볼락', '농어'],  // 삼치 금어기
    8:  ['오징어', '삼치', '고등어', '전갱이'],  // 8/1~ 삼치 해금 | 고등어 방파제 사비키 피크
    // 가을 — 방어·무늬오징어 피크
    9:  ['방어', '삼치', '무늬오징어', '고등어'],  // 고등어 마란 | 방어 최성기
    10: ['방어', '무늬오징어', '감성돔', '삼치'],
    // 늦가울~겨울 — 볼락 11월 피크 | 감성돔·방어 활성
    11: ['감성돔', '볼락', '방어', '무늬오징어'],
    12: ['가자미', '이면수', '볼락', '우럭'],
  },
  '서해': {
    ...
    7:  ['광어', '농어', '우럭', '갑오징어'],  // 쭈꾸미·삼치 금어기 / 갑오징어 사이즈 궁음
    8:  ['농어', '광어', '고등어', '우럭'],     // 쭈꾸미 금어기 | 고등어 시즌 시작
  ...
  '남해': {
    ...
    9:  ['갈치', '방어', '무늬오징어', '고등어'],  // 고등어 9월 남해 방파제 마릿수 피크
