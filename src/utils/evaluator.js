...
const FISH_ALERTS = {
  ...
  '대구':      { alert: '동해 깊은 수심 대구 지깅의 계절입니다. 묵직한 메탈 지그를 준비하세요.',    gear: '메탈지그 200~300g, 대구 전용 지깅대' },
  '도루묵':    { alert: '초겨울 동해안 도루묵 시즌입니다. 연안 방파제 주변을 노리세요.',            gear: '통발 또는 다수 바늘 채비' },
  '민어':      { alert: '여름 서해의 귀족, 민어 시즌입니다. 외줄 생미끼 낚시가 유리합니다.',        gear: '외줄낚시 16~20호 바늘, 생새우/낙지 미끼' },
  '백조기':    { alert: '서해 백조기(보구치) 낚시가 한창입니다. 청갯지렁이 미끼를 두둑이 챙기세요.', gear: '원투 채비 12~16호 바늘, 넉넉한 청갯지렁이' },
  '호래기':    { alert: '겨울 남해 방파제 호래기(꼴뚜기) 낚시 적기입니다. 소형 에기를 준비하세요.',  gear: '호래기 전용 슷테, 소형 에기(1.5호)' },
  '성대':      { alert: '모래 바닥층에서 성대의 입질이 활발합니다. 화려한 채비에 반응이 좋습니다.',  gear: '원투낚시, 화려한 스커트 웜' },
