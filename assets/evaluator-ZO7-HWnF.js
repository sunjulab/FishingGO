 ...
 */
const calculateFishingScore = (data, point = {}) => {
 ...
 * 낚시 조건 종합 평가
 */
const evaluateFishingCondition = (data, point = {}) => {
 ...
 */
const getDynamicPointScore = (point, getPointSpecificDataFn = null) => {
...
export { evaluateFishingCondition as e };
