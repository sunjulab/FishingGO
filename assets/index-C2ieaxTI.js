function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/index-Bs_rOFuH.js","assets/vendor-react-BzbiWsGG.js","assets/vendor-icons-C5BxRig-.js","assets/vendor-store-DFdRS9Cc.js","assets/vendor-http-ChhVHlBG.js","assets/vendor-socket-FPM1Bwz4.js","assets/index-CNOrOr4U.js","assets/index-DExIcnXn.js","assets/index-djydVqf1.js","assets/index-C1yKy13k.js","assets/web-C2DfFdY6.js","assets/MapHome-DP7GKoSJ.js","assets/evaluator-ZO7-HWnF.js","assets/AdUnit-B8AAt_Ku.js","assets/fishingData-DUAFbpZH.js","assets/AdSenseAd-BKj4OeVC.js","assets/MediaTab-u1S8ze3_.js","assets/CommunityTab-lW6BdCpW.js","assets/ImageGallery-BLN2ACrS.js","assets/shareUtils-C91mtvog.js","assets/Shop-8SendtLs.js","assets/MyPage-k9lT1KNX.js","assets/imageUtils-BQ2gh6yW.js","assets/WritePost-Vk-L7fhX.js","assets/MultiImageUpload-B1jhwcl6.js","assets/CreateCrew-DKQbqsj7.js","assets/PostDetail-BvhRDXeH.js","assets/CatchDetail-_K-gibun.js","assets/LoginPage-BX2_mDyu.js","assets/CrewChat-BALzHzbj.js","assets/WeatherDashboard-SawreI0A.js","assets/VVIPSubscribe-Bphj9YPZ.js","assets/WriteBusinessPost-BJ3v_DYX.js","assets/CctvAdmin-CiQHBv35.js","assets/NoticeDetail-DNT5xarA.js","assets/SecretPointAdmin-ktrNvGBD.js","assets/PaymentHistory-RwcY_sbI.js","assets/payment-DHpLMO2g.js","assets/AdminDashboard-CdU40WCX.js","assets/UserProfile-BA6tc6Yx.js","assets/CatchUploadPage-D-NIthzo.js","assets/fishRules-C-ea2o-Y.js","assets/CatchRankingPage-D1aFcxHc.js","assets/ContestPage-afwg3IVj.js","assets/PointLocationAdmin-DZgLAlYr.js"]
  }
...
async function initAdMob() {
  if (!isNative())
    return;
  try {
    const mod = await __vitePreload(() => import('./index-Bs_rOFuH.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0);
    AdMob = mod.AdMob;
...
async function initPushPermission(userId) {
  ...
  try {
    const { PushNotifications } = await __vitePreload(() => import('./index-CNOrOr4U.js'),true?__vite__mapDeps([6,1,2,3,4,5]):void 0);
...
async function requestLocationPermission() {
  ...
  try {
    const { Geolocation } = await __vitePreload(() => import('./index-DExIcnXn.js'),true?__vite__mapDeps([7,1,2,3,4,5]):void 0);
...
async function requestCameraPermission() {
  ...
  try {
    const { Camera } = await __vitePreload(() => import('./index-djydVqf1.js'),true?__vite__mapDeps([8,1,2,3,4,5]):void 0);
...
async function initNetworkMonitor(onOffline, onOnline) {
  ...
  try {
    const { Network } = await __vitePreload(() => import('./index-C1yKy13k.js'),true?__vite__mapDeps([9,1,2,3,4,5]):void 0);
...
const AppUpdate = registerPlugin('AppUpdate', {
    web: () => __vitePreload(() => import('./web-C2DfFdY6.js'),true?__vite__mapDeps([10,1,2,3,4,5]):void 0).then(m => new m.AppUpdateWeb()),
});

const CURRENT_APP_VERSION = true ? "2.1.50" : "2.1.17";
...
const MapHome = reactExports.lazy(() => __vitePreload(() => import('./MapHome-DP7GKoSJ.js'),true?__vite__mapDeps([11,1,2,12,13,14,15,3,4,5]):void 0));
const MediaTab = reactExports.lazy(() => __vitePreload(() => import('./MediaTab-u1S8ze3_.js'),true?__vite__mapDeps([16,1,2,3,4,5]):void 0));
const CommunityTab = reactExports.lazy(() => __vitePreload(() => import('./CommunityTab-lW6BdCpW.js'),true?__vite__mapDeps([17,1,2,13,15,18,5,19,3,4]):void 0));
const Shop = reactExports.lazy(() => __vitePreload(() => import('./Shop-8SendtLs.js'),true?__vite__mapDeps([20,1,2,3,4,5]):void 0));
const MyPage = reactExports.lazy(() => __vitePreload(() => import('./MyPage-k9lT1KNX.js'),true?__vite__mapDeps([21,1,22,15,2,3,4,5]):void 0));
const WritePost = reactExports.lazy(() => __vitePreload(() => import('./WritePost-Vk-L7fhX.js'),true?__vite__mapDeps([23,1,2,13,24,22,3,4,5]):void 0));
const CreateCrew = reactExports.lazy(() => __vitePreload(() => import('./CreateCrew-DKQbqsj7.js'),true?__vite__mapDeps([25,1,2,13,3,4,5]):void 0));
const PostDetail = reactExports.lazy(() => __vitePreload(() => import('./PostDetail-BvhRDXeH.js'),true?__vite__mapDeps([26,1,2,18,19,15,3,4,5]):void 0));
const CatchDetail = reactExports.lazy(() => __vitePreload(() => import('./CatchDetail-_K-gibun.js'),true?__vite__mapDeps([27,1,2,19,3,4,5]):void 0));
const LoginPage = reactExports.lazy(() => __vitePreload(() => import('./LoginPage-BX2_mDyu.js'),true?__vite__mapDeps([28,1,2,3,4,5]):void 0));
const CrewChat = reactExports.lazy(() => __vitePreload(() => import('./CrewChat-BALzHzbj.js'),true?__vite__mapDeps([29,1,5,2,22,3,4]):void 0));
const WeatherDashboard = reactExports.lazy(() => __vitePreload(() => import('./WeatherDashboard-SawreI0A.js'),true?__vite__mapDeps([30,1,2,14,12,3,4,5]):void 0));
const VVIPSubscribe = reactExports.lazy(() => __vitePreload(() => import('./VVIPSubscribe-Bphj9YPZ.js'),true?__vite__mapDeps([31,1,2,3,4,5]):void 0));
const WriteBusinessPost = reactExports.lazy(() => __vitePreload(() => import('./WriteBusinessPost-BJ3v_DYX.js'),true?__vite__mapDeps([32,1,2,24,22,3,4,5]):void 0));
const CctvAdmin = reactExports.lazy(() => __vitePreload(() => import('./CctvAdmin-CiQHBv35.js'),true?__vite__mapDeps([33,1,2,3,4,5]):void 0));
const NoticeDetail = reactExports.lazy(() => __vitePreload(() => import('./NoticeDetail-DNT5xarA.js'),true?__vite__mapDeps([34,1,2,18,5,19,3,4]):void 0));
const SecretPointAdmin = reactExports.lazy(() => __vitePreload(() => import('./SecretPointAdmin-ktrNvGBD.js'),true?__vite__mapDeps([35,1,2,14,3,4,5]):void 0));
const PaymentHistory = reactExports.lazy(() => __vitePreload(() => import('./PaymentHistory-RwcY_sbI.js'),true?__vite__mapDeps([36,1,2,37,3,4,5]):void 0));
const AdminDashboard = reactExports.lazy(() => __vitePreload(() => import('./AdminDashboard-CdU40WCX.js'),true?__vite__mapDeps([38,1,2,37,3,4,5]):void 0));
const UserProfile = reactExports.lazy(() => __vitePreload(() => import('./UserProfile-BA6tc6Yx.js'),true?__vite__mapDeps([39,1,2,3,4,5]):void 0));
const CatchUploadPage = reactExports.lazy(() => __vitePreload(() => import('./CatchUploadPage-D-NIthzo.js'),true?__vite__mapDeps([40,1,2,41,3,4,5]):void 0));
const CatchRankingPage = reactExports.lazy(() => __vitePreload(() => import('./CatchRankingPage-D1aFcxHc.js'),true?__vite__mapDeps([42,1,2,41,13,15,3,4,5]):void 0));
const ContestPage = reactExports.lazy(() => __vitePreload(() => import('./ContestPage-afwg3IVj.js'),true?__vite__mapDeps([43,1,2,41,3,4,5]):void 0));
const PointLocationAdmin = reactExports.lazy(() => __vitePreload(() => import('./PointLocationAdmin-DZgLAlYr.js'),true?__vite__mapDeps([44,1,2,14,3,4,5]):void 0));
