...
import { _ as __vitePreload, R as React } from './vendor-react-BzbiWsGG.js';
...
class DashVideoElement extends MediaTracksMixin(CustomVideoElement) {
  ...
  async load() {
    ...
    this.#apiInit = true;
    const Dash = await __vitePreload(() => import('./dash.all.min-hDHGrj_x.js'),true?__vite__mapDeps([]):void 0);
