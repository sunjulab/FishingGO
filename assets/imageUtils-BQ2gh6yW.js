 ...
 */
async function fileToCompressedBase64(file, options = {}) {
  return new Promise((resolve, reject) => {
 ...
 */
async function compressAvatar(base64) {
 ...
 */
const isWebPSupported = WEBP_SUPPORTED;

export { compressAvatar, compressImage, fileToCompressedBase64, isWebPSupported };
