...
const WATER_TEMP_OBS_MAP = {
  ...
  'DT_0004': 'DT_0063',  // 부산 해운대  → 거제 35.02°N (남해동부 최근접, 기존 포항 매핑 오류 수정)
...
const NIFS_STA_MAP = {
  ...
  'DT_0036': 'bgj8a',  // 포항/울산 → 기장 (인접)
  'DT_0034': 'gi086',  // 거제      → 거제 일운
  'DT_0016': 'ty004',  // 통영      → 통영 영운
  'DT_0004': 'fnm5b',  // 남해      → 남해 미조
  'DT_0005': 'km001',  // 여수      → 여수 신월
  'DT_0014': 'fjh5a',  // 진도(남해) → 해남 임하
  'DT_0018': 'wk094',  // 완도      → 완도 금일
  'DT_0006': 'emp67',  // 목포      → 목포
  'DT_0009': 'egsi4',  // 군산      → 군산 신시도
  'DT_0008': 'fbsp5',  // 보령      → 보령 소도
  'DT_0030': 'ftpk5',  // 태안      → 태안 파도리
  'DT_0007': 'fbn69',  // 인천      → 백령도 (서해 북부 커버)
  'DT_0010': 'ejj47',  // 제주(서쪽) → 서제주
  'DT_0011': 'ejj47',  // 서귀포     → 서제주 (제주 남부 NIFS 부재로 서제주 공유)
