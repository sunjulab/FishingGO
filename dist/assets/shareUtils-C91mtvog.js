function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/index-BLTdMUAl.js","assets/index-C2ieaxTI.js","assets/vendor-react-BzbiWsGG.js","assets/vendor-icons-C5BxRig-.js","assets/vendor-store-DFdRS9Cc.js","assets/vendor-http-ChhVHlBG.js","assets/vendor-socket-FPM1Bwz4.js","assets/index-DKFtvhIq.css","assets/index-BRrskzl9.js"]
  }
...
async function copyToClipboard(text) {
  try {
    const { Clipboard } = await __vitePreload(() => import('./index-BLTdMUAl.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0);
...
async function openKakaoTalk() {
  try {
    const { AppLauncher } = await __vitePreload(() => import('./index-BRrskzl9.js'),true?__vite__mapDeps([8,2,1,3,4,5,6,7]):void 0);
...
${pageUrl}`;
  ...
  if (isNative) {
    try {
      const { registerPlugin } = await __vitePreload(() => import('./index-C2ieaxTI.js').then(n => n.i),true?__vite__mapDeps([1,2,3,4,5,6,7]):void 0);
