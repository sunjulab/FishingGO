const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-CG_kwIxd.js","assets/index-DvZBU_x5.js","assets/vendor-react-vfOo6a0P.js","assets/vendor-icons-Bsle_tIe.js","assets/vendor-store-wmv-LjAu.js","assets/vendor-http-ChhVHlBG.js","assets/vendor-socket-DJUzVLd_.js","assets/index-Iv7s_lDn.css"])))=>i.map(i=>d[i]);
...
const AdMob = registerPlugin('AdMob', {
    web: () => __vitePreload(() => import('./web-CG_kwIxd.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7]):void 0).then((m) => new m.AdMobWeb()),
});
