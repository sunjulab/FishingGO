function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/index-B7Y86HJt.js","assets/vendor-react-BzbiWsGG.js","assets/vendor-icons-C5BxRig-.js","assets/vendor-store-DFdRS9Cc.js","assets/vendor-http-ChhVHlBG.js","assets/vendor-socket-FPM1Bwz4.js","assets/index-DLCy-WKq.js","assets/index-BpbYm62i.js","assets/index-BkF23_In.js","assets/index-hsIgID8f.js","assets/web-CSjNtuGm.js","assets/MapHome-DQJT7FUn.js","assets/evaluator-ZO7-HWnF.js","assets/AdUnit-BqORXC3x.js","assets/fishingData-DUAFbpZH.js","assets/AdSenseAd-CQtTSdZ4.js","assets/MediaTab-DoT5bXss.js","assets/CommunityTab-DxYQAG29.js","assets/ImageGallery-CWITbden.js","assets/shareUtils-Dak8IxHe.js","assets/Shop-C1Yjl4oA.js","assets/MyPage-XH5DA5x6.js","assets/imageUtils-BQ2gh6yW.js","assets/WritePost-BlWfTvJw.js","assets/MultiImageUpload-BINsASJj.js","assets/CreateCrew-mZKmrFDf.js","assets/PostDetail-BZBesgvP.js","assets/CatchDetail-Cr6MzUL4.js","assets/LoginPage-J0lO_H_s.js","assets/CrewChat-Dn4skTJU.js","assets/WeatherDashboard-CN7Mdt8U.js","assets/VVIPSubscribe-B8Vy7iik.js","assets/WriteBusinessPost-BXFfDd85.js","assets/CctvAdmin-CTAH-G0m.js","assets/NoticeDetail-CcOJfiy7.js","assets/SecretPointAdmin-BRaaHGwN.js","assets/PaymentHistory-eE_6KflL.js","assets/payment-DHpLMO2g.js","assets/AdminDashboard-ROsXaN3P.js","assets/UserProfile-CQRsQOR0.js","assets/CatchUploadPage-C-5UiZx6.js","assets/fishRules-C-ea2o-Y.js","assets/CatchRankingPage-DC9x5Ves.js","assets/ContestPage-DUO_AcYH.js","assets/PointLocationAdmin-VLcFnSVq.js"]
  }
...
async function initAdMob() {
  if (!isNative())
    return;
  try {
    const mod = await __vitePreload(() => import('./index-B7Y86HJt.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0);
    AdMob = mod.AdMob;
...
async function initPushPermission(userId) {
  ...
  try {
    const { PushNotifications } = await __vitePreload(() => import('./index-DLCy-WKq.js'),true?__vite__mapDeps([6,1,2,3,4,5]):void 0);
...
async function requestLocationPermission() {
  ...
  try {
    const { Geolocation } = await __vitePreload(() => import('./index-BpbYm62i.js'),true?__vite__mapDeps([7,1,2,3,4,5]):void 0);
...
async function requestCameraPermission() {
  ...
  try {
    const { Camera } = await __vitePreload(() => import('./index-BkF23_In.js'),true?__vite__mapDeps([8,1,2,3,4,5]):void 0);
...
async function initNetworkMonitor(onOffline, onOnline) {
  ...
  try {
    const { Network } = await __vitePreload(() => import('./index-hsIgID8f.js'),true?__vite__mapDeps([9,1,2,3,4,5]):void 0);
...
const AppUpdate = registerPlugin('AppUpdate', {
    web: () => __vitePreload(() => import('./web-CSjNtuGm.js'),true?__vite__mapDeps([10,1,2,3,4,5]):void 0).then(m => new m.AppUpdateWeb()),
});

const CURRENT_APP_VERSION = true ? "2.1.49" : "2.1.17";
...
const MapHome = reactExports.lazy(() => __vitePreload(() => import('./MapHome-DQJT7FUn.js'),true?__vite__mapDeps([11,1,2,12,13,14,15,3,4,5]):void 0));
const MediaTab = reactExports.lazy(() => __vitePreload(() => import('./MediaTab-DoT5bXss.js'),true?__vite__mapDeps([16,1,2,3,4,5]):void 0));
const CommunityTab = reactExports.lazy(() => __vitePreload(() => import('./CommunityTab-DxYQAG29.js'),true?__vite__mapDeps([17,1,2,13,15,18,5,19,3,4]):void 0));
const Shop = reactExports.lazy(() => __vitePreload(() => import('./Shop-C1Yjl4oA.js'),true?__vite__mapDeps([20,1,2,3,4,5]):void 0));
const MyPage = reactExports.lazy(() => __vitePreload(() => import('./MyPage-XH5DA5x6.js'),true?__vite__mapDeps([21,1,22,15,2,3,4,5]):void 0));
const WritePost = reactExports.lazy(() => __vitePreload(() => import('./WritePost-BlWfTvJw.js'),true?__vite__mapDeps([23,1,2,13,24,22,3,4,5]):void 0));
const CreateCrew = reactExports.lazy(() => __vitePreload(() => import('./CreateCrew-mZKmrFDf.js'),true?__vite__mapDeps([25,1,2,13,3,4,5]):void 0));
const PostDetail = reactExports.lazy(() => __vitePreload(() => import('./PostDetail-BZBesgvP.js'),true?__vite__mapDeps([26,1,2,18,19,15,3,4,5]):void 0));
const CatchDetail = reactExports.lazy(() => __vitePreload(() => import('./CatchDetail-Cr6MzUL4.js'),true?__vite__mapDeps([27,1,2,19,3,4,5]):void 0));
const LoginPage = reactExports.lazy(() => __vitePreload(() => import('./LoginPage-J0lO_H_s.js'),true?__vite__mapDeps([28,1,2,3,4,5]):void 0));
const CrewChat = reactExports.lazy(() => __vitePreload(() => import('./CrewChat-Dn4skTJU.js'),true?__vite__mapDeps([29,1,5,2,22,3,4]):void 0));
const WeatherDashboard = reactExports.lazy(() => __vitePreload(() => import('./WeatherDashboard-CN7Mdt8U.js'),true?__vite__mapDeps([30,1,2,14,12,3,4,5]):void 0));
const VVIPSubscribe = reactExports.lazy(() => __vitePreload(() => import('./VVIPSubscribe-B8Vy7iik.js'),true?__vite__mapDeps([31,1,2,3,4,5]):void 0));
const WriteBusinessPost = reactExports.lazy(() => __vitePreload(() => import('./WriteBusinessPost-BXFfDd85.js'),true?__vite__mapDeps([32,1,2,24,22,3,4,5]):void 0));
const CctvAdmin = reactExports.lazy(() => __vitePreload(() => import('./CctvAdmin-CTAH-G0m.js'),true?__vite__mapDeps([33,1,2,3,4,5]):void 0));
const NoticeDetail = reactExports.lazy(() => __vitePreload(() => import('./NoticeDetail-CcOJfiy7.js'),true?__vite__mapDeps([34,1,2,18,5,19,3,4]):void 0));
const SecretPointAdmin = reactExports.lazy(() => __vitePreload(() => import('./SecretPointAdmin-BRaaHGwN.js'),true?__vite__mapDeps([35,1,2,14,3,4,5]):void 0));
const PaymentHistory = reactExports.lazy(() => __vitePreload(() => import('./PaymentHistory-eE_6KflL.js'),true?__vite__mapDeps([36,1,2,37,3,4,5]):void 0));
const AdminDashboard = reactExports.lazy(() => __vitePreload(() => import('./AdminDashboard-ROsXaN3P.js'),true?__vite__mapDeps([38,1,2,37,3,4,5]):void 0));
const UserProfile = reactExports.lazy(() => __vitePreload(() => import('./UserProfile-CQRsQOR0.js'),true?__vite__mapDeps([39,1,2,3,4,5]):void 0));
const CatchUploadPage = reactExports.lazy(() => __vitePreload(() => import('./CatchUploadPage-C-5UiZx6.js'),true?__vite__mapDeps([40,1,2,41,3,4,5]):void 0));
const CatchRankingPage = reactExports.lazy(() => __vitePreload(() => import('./CatchRankingPage-DC9x5Ves.js'),true?__vite__mapDeps([42,1,2,41,13,15,3,4,5]):void 0));
const ContestPage = reactExports.lazy(() => __vitePreload(() => import('./ContestPage-DUO_AcYH.js'),true?__vite__mapDeps([43,1,2,41,3,4,5]):void 0));
const PointLocationAdmin = reactExports.lazy(() => __vitePreload(() => import('./PointLocationAdmin-VLcFnSVq.js'),true?__vite__mapDeps([44,1,2,14,3,4,5]):void 0));
