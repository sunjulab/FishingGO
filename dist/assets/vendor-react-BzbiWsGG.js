    ...
    if (routeModule) {
      ...
      dataRoute.lazy = {
        loader: route.hasClientLoader ? async () => {
          let { clientLoader } = route.clientLoaderModule ? await __vitePreload(() => import(
            /* @vite-ignore */
            /* webpackIgnore: true */
            route.clientLoaderModule
          ),true?__vite__mapDeps([]):void 0) : await getLazyRoute();
        ...
        action: route.hasClientAction ? async () => {
          let clientActionPromise = route.clientActionModule ? __vitePreload(() => import(
            /* @vite-ignore */
            /* webpackIgnore: true */
            route.clientActionModule
          ),true?__vite__mapDeps([]):void 0) : getLazyRoute();
          prefetchRouteModuleChunks(route);
        ...
        middleware: route.hasClientMiddleware ? async () => {
          let { clientMiddleware } = route.clientMiddlewareModule ? await __vitePreload(() => import(
            /* @vite-ignore */
            /* webpackIgnore: true */
...
export { BrowserRouter as B, NavLink as N, React as R, __vitePreload as _, reactDomExports as a, useLocation as b, Navigate as c, Routes as d, Route as e, useSearchParams as f, getDefaultExportFromCjs as g, useParams as h, reactExports as r, useNavigate as u };
