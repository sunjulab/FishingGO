import { W as WebPlugin, C as CapacitorException, r as registerPlugin } from './index-DvZBU_x5.js';
...
const Camera$1 = new CameraWeb();

const Camera = registerPlugin('Camera', {
    web: () => new CameraWeb(),
});

export { Camera, CameraDirection, CameraErrorCode, CameraResultType, CameraSource, EncodingType, MediaType, MediaTypeSelection };
